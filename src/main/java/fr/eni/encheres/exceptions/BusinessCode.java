...
public class BusinessCode {
	...
	public static final String VALIDATION_USER_MDP = "validation.user.mdp";
	public static final String VALIDATION_USER_MDP_SIMILAIRE = "validation.user.mdp.similaire";
